...
<h2>Jobcard Applicants Details</h2>
...
<!-- <td> <a href="adharview.php?id=<?php echo $row['regid']; ?>"> VIEW</a> </td>-->
   <td><button class="" name="submit" onclick="window.location.href='adharview.php?id=<?php echo $row3['regid']; ?>'">View</button>
