...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  <a href="login.php" style="font-size:20pt; color:#ffffff;">Login</a>
  <li class="dropdown">
    <a href="personal1.php" style="font-size:20pt; padding:3px; color:#ffffff;">Apply Jobcard</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    ...
    <div class="dropdown-content">
	  ...
	  <!--<a href="personal1.php" style="font-size:15pt;">Apply</a><br>
     <!-- <a href="downloadjbcard.php" style="font-size:15pt;">Download</a><br>-->
     </div>
  </li>
